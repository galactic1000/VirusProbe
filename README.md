...
An efficient malware scanning tool powered by VirusTotal. Scan files, directories, or SHA-256 hashes with both CLI and GUI interfaces. Features intelligent caching, concurrent scanning, and automatic file upload for undetected samples.
